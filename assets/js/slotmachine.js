  ...
  3: [function (require, module, exports) {
    ...
    var SlotMachine = function () {
      ...
      _createClass(SlotMachine, [{
        ...
        key: 'shuffle',
        value: function shuffle(spins, onComplete, fixed, fixedArraySpin) {
          var _this3 = this;
          ...
          if (!this.visible && this.inViewport === true) {
            this.stop(onComplete, fixed, fixedArraySpin);
          } else {
            ...
            raf(function () {
              if (!_this3.stopping && _this3.running) {
                ...
                if (left > 1) {
                  // Repeat animation
                  _this3.shuffle(left, onComplete, fixed, fixedArraySpin);
                } else {
                  _this3.stop(onComplete, fixed, fixedArraySpin);
                }
              }
            }, delay);
          }
        ...
        key: 'stop',
        value: function stop(onStop, fixed, fixedArraySpin) {
          var _this4 = this;
          ...
          this.running = true;
          this.stopping = true;
          this.fixedArraySpin = fixedArraySpin;
          ...
          if (fixed == 1) {
            this._changeTransform(this.getTileOffset(this.fixedArraySpin));
            //console.log("fixed array at: " + this.fixedArraySpin);
          } else {
